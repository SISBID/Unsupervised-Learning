#############################################################
#2018 SISBID Module 5 - Unsupervised Learning
...
#2) corrected for overdispersion by a log-transformation (1 + data)
...
#Problem 3c - Examine the lists of genes identified using different methods for each clinical response.  Which method is best?  Why?

############
#Problem 4 - Graphical models
############

# Use graphical models to explore interactions among genes.  Are any of the well-connected genes related to patterns previously identified? 


##################
#Problem 5 - Visulaization
#################

#Visualize this data using multiple approaches.

#Prepare the "best" visual summary of this data.
...
#Is this finding consistent and stable?

#Prepare a visual summary that best illustrates this interesting finding.
...
#MDS 
dev.off()
Dmat = dist(gdat,method="manhattan")
mdsres = cmdscale(Dmat,k=2)
plot(mdsres[,1],mdsres[,2],pch=16,col=Cols(cdat$Subtype))
legend(-300,300,pch=16,col=rainbow(5),levels(cdat$Subtype))
