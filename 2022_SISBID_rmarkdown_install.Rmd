...
# Install Packages
In order to install the packages needed to complete the labs, please refer to the r packages Rmd file. The file contains the packages needed for the module, organized by each lab. To install, place cursor on the line you would like to run and click the "Run" button at the top of the document. 
